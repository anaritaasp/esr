...
class RP(Node):
    ...
    # Adiciona um servidor à tabela de servidores ativos
    def add_server_to_active_servers(self, server_id, source, metric, contents, state):
    ...
    # Atualiza informações de um servidor na tabela de servidores ativos
    def update_server_info(self, server_id, key, value):
        if server_id in self.active_servers:
            self.active_servers[server_id][key] = value

    # Obtém informações de um servidor da tabela de servidores ativos
    def get_server_info(self, server_id):
        return self.active_servers.get(server_id, None)

    # Remove um servidor da tabela de servidores ativos
    def remove_server_from_active_servers(self, server_id):
        if server_id in self.active_servers:
